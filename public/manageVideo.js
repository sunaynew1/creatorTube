 ...
 async function fetchData(){
  const req = await fetch("https://creator-tube-three.vercel.app/api/v1/users/myVideos",{
    method:"POST",
    headers: {
 ...
 async function deleteAVideo(videopublicId,thumbnailpublicId){
  ...
  const req = await fetch("https://creator-tube-three.vercel.app/api/v1/users/deleteVideo",{
  ...
  async  function deleteVideo(id) {
   ...
   async function saveEdit() {
    ...
    const req = await fetch("https://creator-tube-three.vercel.app/api/v1/users/editVideo",{
    method:"POST",
    headers: {
        "Content-Type" : "application/json"
    },
