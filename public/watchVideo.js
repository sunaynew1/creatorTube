...
async function registerView() {
  const registerView = await fetch("http://localhost:3004/api/v1/users/views", {
...
async function videoData() {
  try {
    ...
    const reqvideoData = await fetch("http://localhost:3004/api/v1/users/videoData", {
    ...
    const reqUserData = await fetch("http://localhost:3004/api/v1/users/userInfo", {
    ...
    async function newComment(videoId, comment) {
      const resNewComment = await fetch("http://localhost:3004/api/v1/users/comment", {
    ...
    async function like(videoId) {
      let reqLike = await fetch("http://localhost:3004/api/v1/users/like", {
    ...
    async function subscriberCheck(channelId) {
      let reqLike = await fetch("http://localhost:3004/api/v1/users/subscribeCheck", {
    ...
    async function subscribe() {
      ...
      let reqLike = await fetch("http://localhost:3004/api/v1/users/subscribe", {
    ...
    async function dislike(videoId) {
      let reqDisLike = await fetch("http://localhost:3004/api/v1/users/dislike", {
