...
async function forgotPassword(mailId) {
    const req = await fetch("http://creatortube-production.up.railway.app/api/v1/users/Mail",{
        method:"POST",
        headers: {
...
async function fetchData() {
    const req = await fetch("http://creatortube-production.up.railway.app/api/v1/users/allData", {
        method: "POST",
        headers: {
...
async function postAboutMe(aboutMe) {
    try {
        const req = await fetch("http://creatortube-production.up.railway.app/api/v1/users/postAboutMe", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function changeCurrentPassword(oldPassword, newPassword) {
    try {
        const req = await fetch("http://creatortube-production.up.railway.app/api/v1/users/change-password", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
