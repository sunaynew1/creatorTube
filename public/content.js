...
async function redirectWatch() {
  const req = await fetch("http://creatortube-production.up.railway.app/api/v1/users/watch",{
    method:"POST",
    headers: {
...
async function fetchVideos() {
  try {
    const res = await fetch("http://creatortube-production.up.railway.app/api/v1/users/content", {
