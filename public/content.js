...
async function redirectWatch() {
  const req = await fetch("https://creatortube-production.up.railway.app/api/v1/users/watch",{
    method:"POST",
    headers: {
...
async function fetchVideos() {
  try {
    const res = await fetch("https://creatortube-production.up.railway.app/api/v1/users/content", {
