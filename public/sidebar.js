  async function userData(){
    const req = await fetch("https://creator-tube-phi.vercel.app/api/v1/users/onlyId", {
        method : "POST",
        headers: {
  ...
  async function logout(){
    const req = await fetch("https://creator-tube-phi.vercel.app/api/v1/users/logout", {
        method : "POST",
        headers: {
            "Content-Type" : "application/json"
        },
